standard_prompt = '''Write a research report about {topic} that incorporates the answers to the following {n} questions: {questions}
'''

cot_prompt = '''Write a research report about {topic} that incorporates the answers to the following {n} questions: {questions}
...
Task: Write a research report about {topic} that incorporates the answers to the following {n} questions: {questions}
'''
